...
public:
    void duplicateZeros(vector<int>& arr) {
        ...
        // Định dạng về vị trí phần tử hợp lệ
        // Dành cho trường hợp dem = n
        int j = n - 1; 
        i--;

        if (dem > n) {
            // Trường hợp chắc chắn số 0 ở vị trí cuối cùng, số 0 chỉ có thể giữ nguyên, không thể nhân đổi
            // Vì thế ta phải i--, j-- để tránh gây sai sót do vòng lặp cuối thực hiện
            arr[j] = 0;
            j--;
            i--;
        }
